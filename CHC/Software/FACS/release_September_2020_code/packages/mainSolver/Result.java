...
public class Result
{
	...
	private boolean bestSolutionFoundByPart2 = false;
	private  int[] dpBestCSFound2; //The best coalition structure found by DP, IDP, or ODP
	...
	public void updateDPSolution2( int[] CS, double value ){
		//set_dpBestCSFound( CS );
		//set_dpValueOfBestCSFound( value );
		//if( get_dpValueOfBestCSFound() < value ){
			set_dpValueOfBestCSFound( value );
			set_dpBestCSFound( CS );
	...
	public synchronized int[] get_dpBestCSFound2(){
		return dpBestCSFound2;		
	}
	public void set_bestSolutionFoundByPart2(){
		bestSolutionFoundByPart2 = true;
	}
	public boolean get_bestSolutionFoundByPart2(){
		return bestSolutionFoundByPart2;
	}
	//Fin modif
