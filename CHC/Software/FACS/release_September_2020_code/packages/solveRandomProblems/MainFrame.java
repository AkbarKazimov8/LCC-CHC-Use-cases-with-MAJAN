...
public class MainFrame extends JFrame
{
	...
	JRadioButton chiSquare_radioButton = new JRadioButton();
	JRadioButton weibull_radioButton = new JRadioButton();
	JRadioButton f_radioButton = new JRadioButton();
	...
	JRadioButton runexactHDP_radioButton = new JRadioButton();
	JRadioButton runProposition2_radioButton = new JRadioButton();
	JRadioButton runProposition3_radioButton = new JRadioButton();
	JRadioButton runEDP_radioButton = new JRadioButton();
	...
	public Input readInputFromGUI()
	{
		...
		else if (chiSquare_radioButton.isSelected()) input.valueDistribution = ValueDistribution.CHISQUARE;
		else if (weibull_radioButton.isSelected()) input.valueDistribution = ValueDistribution.WEIBULL;
		else if (f_radioButton.isSelected()) input.valueDistribution = ValueDistribution.NORMAL;
		...
		else if( runexactHDP_radioButton.isSelected()  ) input.solverName = SolverNames.NEWHDP;
		else if( runProposition2_radioButton.isSelected()  ) input.solverName = SolverNames.PROPOSITION2;
		else if( runProposition3_radioButton.isSelected()  ) input.solverName = SolverNames.FACS;
		else if( runEDP_radioButton.isSelected()  ) input.solverName = SolverNames.EDP;
	...
	public void printResultOnGUI(Input input, Result result)
	{
		...
		if ( (input.solverName == SolverNames.FACS) || (input.solverName == SolverNames.PROPOSITION2) || (input.solverName == SolverNames.NEWHDP) || (input.solverName == SolverNames.EDP) || (input.solverName == SolverNames.DP) || (input.solverName == SolverNames.IDP) || (input.solverName == SolverNames.ODP) ){
			...
			if(result.get_bestSolutionFoundByPart2()){
				int bestCS[] = result.get_dpBestCSFound2();
				String[] coalitions = new String[bestCS.length];
				for(int i=0; i<bestCS.length; i++){
					String str = Integer.toBinaryString(bestCS[i]);
					int binaryCoalition[] = new int[str.length()];
					coalitions[i] = "[";
					int numAgent = 1;
					for(int j=str.length()-1; j>=0; j--, numAgent++){
						if(Character.getNumericValue(str.charAt(j))==1){
							coalitions[i] += (numAgent)+", ";
						}
					}
					coalitions[i] += "]";
				}
				textArea.append("\nThe coalition structure found by "+SolverNames.toString(input.solverName)+":\n"+(Arrays.toString(coalitions))+"\n");
			}
			else{
	...
	private void jbInit() throws Exception
	{
		...
		jPanel3.setBounds(new Rectangle(650, 135, 290, 280));
		...
		/*jPanel3.add(chiSquare_radioButton);
		radioButtonGroup1.add(chiSquare_radioButton);
		chiSquare_radioButton.setText("Chi-square distribution");
		chiSquare_radioButton.setBounds(new Rectangle(6,260,270,22));*/
		
		/*jPanel3.add(weibull_radioButton);
		radioButtonGroup1.add(weibull_radioButton);
		weibull_radioButton.setText("Weibull distribution");
		weibull_radioButton.setBounds(new Rectangle(6,260,270,22));*/
		
		//jPanel3.add(f_radioButton);
		//radioButtonGroup1.add(f_radioButton);
		f_radioButton.setText("F distribution");
		f_radioButton.setBounds(new Rectangle(6,260,270,22));
		
		//8888888888888888888888888888888888888888888888888888888888888888888888888888888
		//888888888888888888888888             jPanel7           888888888888888888888888
		//8888888888888888888888888888888888888888888888888888888888888888888888888888888

		jPanel7.setBounds(new Rectangle(650, 435, 290, 265));
		jPanel7.setBorder(BorderFactory.createEtchedBorder());
		jPanel7.setLayout(null);
	
		jLabel10.setText("    Select an algorithm");
		jLabel10.setBounds(new Rectangle(670, 425, 135, 18));
		...
		jPanel7.add(runexactHDP_radioButton);
		radioButtonGroup2.add(runexactHDP_radioButton);
		runexactHDP_radioButton.setBounds(new Rectangle(6, 35, 270, 22));
		runexactHDP_radioButton.setText("Run exactHDP 2020");
		
		jPanel7.add(runEDP_radioButton);
		radioButtonGroup2.add(runEDP_radioButton);
		runEDP_radioButton.setBounds(new Rectangle(6, 60, 270, 22));
		runEDP_radioButton.setText("Run EDP 2020");

		jPanel7.add(runIDP_radioButton);
		radioButtonGroup2.add(runIDP_radioButton);
		runIDP_radioButton.setBounds(new Rectangle(6, 85, 270, 22));
		...
		runODPIP_radioButton.setBounds(new Rectangle(6, 160, 270,22));
		...
		runCplex_radioButton.setBounds(new Rectangle(6, 185, 270,22));
		runCplex_radioButton.setText("Run ILOG's CPLEX");
		runCplex_radioButton.setEnabled(false);
		
		jPanel7.add(runProposition2_radioButton);
		radioButtonGroup2.add(runProposition2_radioButton);
		runProposition2_radioButton.setBounds(new Rectangle(6, 210, 270, 22));
		runProposition2_radioButton.setText("Run proposition 2 2020");
		
		jPanel7.add(runProposition3_radioButton);
		radioButtonGroup2.add(runProposition3_radioButton);
		runProposition3_radioButton.setBounds(new Rectangle(6, 235, 270, 22));
		runProposition3_radioButton.setText("Run FACS");
	...
	public void solveCSGBasedOnPredefinedInput_radioButton_mouseClicked(MouseEvent e)
	{
		...
		runexactHDP_radioButton.setEnabled(false);
		runProposition2_radioButton.setEnabled(false);
		runProposition3_radioButton.setEnabled(false);
		runEDP_radioButton.setEnabled(false);
		...
		chiSquare_radioButton.setEnabled(false);
		weibull_radioButton.setEnabled(false);
		f_radioButton.setEnabled(false);
	...
	public void solveCSGBasedOnUserInput_radioButton_mouseClicked(MouseEvent e)
	{
		...
		chiSquare_radioButton.setEnabled(true);
		weibull_radioButton.setEnabled(true);
		f_radioButton.setEnabled(true);
		...
		runexactHDP_radioButton.setEnabled(true);
		runProposition2_radioButton.setEnabled(true);
		runProposition3_radioButton.setEnabled(true);
		runEDP_radioButton.setEnabled(true);
